                    ...
                    <div className="current m">
                        ...
                        <div className="row pr">
                            ...
                            <div className="column column-75 o">
                                ...
                                <p>Time left: 3w 2days</p>
                                <p>Status: <span className="warning">Warning</span></p>
                            </div>
                        </div>
                        ...
                        <div className="row pr">
                            ...
                            <div className="column column-75 o">
                                ...
                                <p>Time left: 3w 2days</p>
                                <p>Status: <span className="danger">Danger</span></p>
                            </div>
                        </div>
                ...
                <div className="column column-40 m">
                    ...
                    <div className="row d">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                           Ut laoreet, neque in consectetur
                            imperdiet, lacus sem lobortis enim, vitae accumsan
                            ligula nulla ac lacus. Pellentesque in
                            augue eget nuncdictum sodales. In blandit pellentesque
                             vestibulum. Interdum et malesuada
                            fames ac ante ipsum primis in faucibus. In vel
                             sollicitudin leo.</p>
                    </div>
                        ...
                        <div className="row cmt">
                            ...
                            <div className="column column-80">
                                <p>Lorem ipsum dolor sit, amet consectetur
                                   adipisicing elit. Rem a sit excepturi
                                    quisquam
                                    ullam? Quia inventore consectetur debitis,
                                    error voluptas officiis dolores excepturi
                                    consequuntur officia.</p>
